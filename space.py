...
class ContactListener(b2ContactListener):
    ...
    def BeginContact(self, conctact):
        ...
        if isinstance(conctact.fixtureA.body.userData, Planet):
            print(dir(conctact.fixtureA.body.userData.name))

        if isinstance(conctact.fixtureB.body.userData, Planet):
            print(conctact.fixtureB.body.userData.name)
...
class SpaceScene(ezpygame.Scene):
    ...
    def __init__(self):
        ...
        space_ship = SpaceShip(self.world, (5, 5))
        self.space_ship = space_ship

        planet = Planet(self.world, (10, 5))
        planet.name = "Earth"
        planets.append(planet)
        self.planets.append(planet)

        sun = Sun(self.world, (-10, -5))
        self.sun = sun
